...
public class TpHereCommand {
    ...
    public static int makeRequest(CommandContext<ServerCommandSource> context) throws CommandSyntaxException {
        ...
        LiteralText confirmMessage = new LiteralText("Sending teleport here request to ");
        ...
        PlayerTeleportRequest.createAndSet(target, caller);

        // Send message to target informing of request from caller
        LiteralText informMessage = new LiteralText(" wishes for you to teleport to them.");
